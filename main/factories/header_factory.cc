...
header_factory::header_factory()
{
	...
	factory.insert(std::make_pair(std::string("RETRANSMIT"), 
		new retransmit_header));
	factory.insert(std::make_pair(std::string("KEEPALIVE"), 
		new keepalive_header));
}
